	...
	<section class="main-content-w3layouts-agileits">
		<div class="container">
			...
			<div class="inner-sec">
				<?php  if ($row_count==0) {
		# code...
    						echo "<p style=color:red><b>sorry your search for:<u style=color:black>$search_keyword</u> returned zero results</b></p>";
    						echo "<p><b style=color:white>Suggestions<b><br>Your search item is not available on Our Website<br>Try being more specific with key words<br>Enter key word using title<br>Try search using category<br>Try again later<br></p>";
    						echo "<p><a href=\"http://www.google.com/search?q=" 
    						. $search_keyword . "\" target=\"_blank\" title=\"Look up 
    						" . $search_keyword . " on Google\" style=color:blue>Click here</a> to try the 
    						search on google</p>";
    					}
    					else{
